<template>
  <ul class="sidebar-menu">
    ...
    <li class="active pageLink" v-on:click="toggleMenu">
      <router-link to="/setting2"><i class="fa fa-desktop"></i>
        <span class="page">Register List</span>
      </router-link>
    </li>
    <li class="active pageLink" v-on:click="toggleMenu">
      <router-link to="/jaringan"><i class="fa fa-desktop"></i>
        <span class="page">Jaringan</span>
      </router-link>
    </li>
    <li class="pageLink" v-on:click="toggleMenu">
      <router-link to="/logmodbus"><i class="fa fa-tasks"></i>
        <span class="page">Log Modbus</span>
      </router-link>
    </li>
