!(function (t, e) {
  'object' === typeof exports && 'object' === typeof module
    ...
    : 'function' === typeof define && define.amd
      ? define([], e)
      : 'object' === typeof exports ? (exports.swal = e()) : (t.swal = e());
})(this, function () {
  return (function (t) {
    function e (o) {
    ...
    function (t, e, n) {
      ...
      var l = function (t) {
        ...
        m = function (t, e, n, r) {
          ...
          if (a) {
            if (n === 0) return { text: e };
            if (n === 1) return { text: e, title: r[0] };
            if (n === 2) return d(n, r), { icon: e };
            f(e, n);
          } else {
            if (s && n === 0) return d(n, r), { content: e };
    ...
    function (t, e, n) {
      ...
      e.getContentOpts = function (t) {
        ...
        return o.isPlainObject(t)
          ? Object.assign(e, t)
          : t instanceof Element ? { element: t } : 'input' === t ? r : null;
      };
    },
    function (t, e, n) {
      'use strict';
